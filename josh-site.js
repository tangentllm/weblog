...
function joshBuildHtmlMagazineIsolationCss(scope = JOSH_HTML_MAGAZINE_SCOPE) {
  ...
  return [
    ...
    '--card-warm:' + cardMix + ';',
    '--card-alt:' + cardMix + ';',
    '--navy-deep:var(--josh-color-text)!important;',
    '--navy:color-mix(in srgb,var(--accent,var(--josh-color-primary)) 68%,var(--josh-color-text))!important;',
    '--navy-tint:' + cardMix + ';',
    '--terra-tint:' + softMix('--terra', '#b5543a') + ';',
    '--terra-soft:' + softMix('--terra', '#b85c4a') + ';',
    '--gold-soft:' + softMix('--gold', '#9a7b3f') + ';',
    '--sand-soft:' + softMix('--sand', '#b98a2f') + ';',
    '--line-strong:color-mix(in srgb,var(--josh-color-text) 28%,transparent)!important;',
